...
import 'package:knee_app/models/errors.dart';
import 'package:knee_app/models/medicine.dart';
import 'package:knee_app/pages/home_page.dart';
import 'package:knee_app/pages/new_entry/new_entry_bloc.dart';
import 'package:knee_app/pages/success_screen/success_screen.dart';
...
class _NewEntryPageState extends State<NewEntryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Add New',style: TextStyle(color: kPrimaryColor),),
        backgroundColor: kScaffoldColor,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: kOtherColor), // Set the focused border color here
                  ),
                ),
                style: Theme.of(context).textTheme.subtitle2!.copyWith(color: kOtherColor),
              ),
              ...
              const PanelTitle(title: 'Medicine Type', isRequired: false,titleColor: kPrimaryColor,),
              Padding(
              ...
              const PanelTitle(title: 'Interval Selection', isRequired: true,titleColor: kPrimaryColor,),
              const IntervalSelection(),
              const PanelTitle(title: 'Starting Time', isRequired: true,titleColor: kPrimaryColor,),
              const SelectTime(),
              SizedBox(
                height: 2.h,
              ),
  ...
  initializeNotifications() async {
    var initializationSettingsAndroid =
        const AndroidInitializationSettings('bogocolor');
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        // Let's create a new block for selecting and adding a new entry
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? kScaffoldColor : Colors.white,
          ...
          Padding(
            ...
            child: Container(
              ...
              height: 4.h,
              decoration: BoxDecoration(
                color: isSelected ? const Color(0xFF06607B) : Colors.transparent,
...
class PanelTitle extends StatelessWidget {
  const PanelTitle({Key? key, required this.title, required this.isRequired, this.titleColor})
      : super(key: key);
  final String title;
